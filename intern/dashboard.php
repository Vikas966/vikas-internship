	...
	<div class="desh-main-content">
		<br>
			...
			echo '<div class="widget">
					...
					<div class="chart"> '.($sentamount['sentamount']-$receivedamount['receivedamount']).' rupees</div>
				</div>
				<div class="widget">
					<div class="title">Money Sent</div>
					<div class="chart"> '.$sentamount['sentamount'].' rupees</div>
				</div>
				<div class="widget">
					<div class="title">Money Received</div>
					<div class="chart">'.$receivedamount['receivedamount'].' rupees</div>
				</div>'
				;
				/*
				lass="chart"></div>
